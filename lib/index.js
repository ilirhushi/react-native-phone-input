...
export default class PhoneInput extends Component {
    ...
    updateFlagAndFormatNumber(number, actionAfterSetState = null) {
        var iso2 = this.props.initialCountry || 'us';
        var phoneNumber = this.getDialCode() + number;
        ...
        this.setState({iso2, formattedNumber: phoneNumber, numberWithoutDialCode: number}, actionAfterSetState)
    }
            ...
            <View style={[styles.container, this.props.style]}>
                ...
                <View style={{flex: 1, marginLeft: this.props.offset || 10}}>
                    <TextComponent
                        ...
                        value={this.state.numberWithoutDialCode}
